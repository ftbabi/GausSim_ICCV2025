...
def build_dataloader(dataset,
    ...
    """
    if workers_per_gpu == 0 and persistent_workers:
        persistent_workers = False
        Warning("*"*50+f"num_workers == 0 and persistent_workers == False can work"+"*"*50)
    ...
    # Use dataset's collate function first
    collate_fn = getattr(dataset, 'collate', collate)
